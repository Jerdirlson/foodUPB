...
INSERT INTO `tbl_cliente` VALUES (1,'Jerdirlson Santamaria','3133662807',1,1),(3,'Diegogo','3173542133',1,4),(4,'ANGIE','313123213',1,5);
...
INSERT INTO `tbl_direccion` VALUES (1,'8','16','Santa Ana','Santander',1),(4,'8','16','San Bernardo','Santander',1),(5,'8','12','San bernardo','Floridablanca',0);
...
CREATE TABLE `tbl_factura` (
  ...
  CONSTRAINT `tbl_factura_ibfk_1` FOREIGN KEY (`tbl_usuario_idtbl_usuario`) REFERENCES `tbl_cliente` (`idtbl_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-10-21 12:22:24
