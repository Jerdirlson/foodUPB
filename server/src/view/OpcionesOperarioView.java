...
public class OpcionesOperarioView extends JFrame {
    ...
    public OpcionesOperarioView() {
        setTitle("Administrador Operario");
        setSize(1920, 1080);
    ...
    public void initComponents() {
        ...
        panelProductojButton3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                AgregarOperario agregarOperaio = new AgregarOperario();
